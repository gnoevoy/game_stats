...
from game_stats.defs.dbt.dbt_asset import dbt_resource, dbt_models, hello
...
defs = dg.Definitions(
    assets=[get_players_links, get_players_stats, dbt_models, hello],
    resources={
        "gcs": GCSResource(project=GOOGLE_CLOUD_PROJECT_ID),
        "dbt": dbt_resource,
    },
)
